...
const MarketplaceCategory = withStyles(styles)(
  ({ classes, title, description, active, svgIcon, learnMoreAction }: MarketplaceCategoryProps & WithStyles<typeof styles>) => (
    <Grid container className={classes.root}>
      <Grid item>
        ...
        <Grid item id="footer" className={classes.footer}>
          <Button id={`#marketplace${title.replace(/\s+/g, '')}Button`} variant="outlined" disabled={!active} onClick={learnMoreAction}>
