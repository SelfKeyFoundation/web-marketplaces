...
import { IncorporationsDataPanel } from './data-panel';
...
type IncorporationsTaxesTabProps = WithStyles<typeof styles> & {
  program: any;
}

const IncorporationsTaxesTab = withStyles(styles)(
  ({ classes, program }: IncorporationsTaxesTabProps) => (
