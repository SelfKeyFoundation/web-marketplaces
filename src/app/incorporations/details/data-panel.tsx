...
import { GreenTick, DeniedTick } from 'selfkey-ui/build-esnext/lib/icons';
...
const BooleanProp = withStyles(styles)(
  ({ prop, data, classes }: any) => (
...
const TextProp = withStyles(styles)(
  ({ prop, data, classes }: any) => (
    <React.Fragment>
      {data[prop.id] && (
...
const IncorporationsDataPanel = withStyles(styles)(
  ({ classes, sections, data }: any) => (
