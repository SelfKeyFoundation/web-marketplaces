...
import { primary } from 'selfkey-ui/build-esnext/lib/colors';
...
export const ResumeTableEntry = withStyles(styles)(
  ({ classes, name, idx, value = [] }: any) => {
...
export const ResumeTable = withStyles(styles)(
  ({ classes, items = [] }: any) => (
...
export const ResumeBox = withStyles(styles)(
  ({ classes, className, itemSets = [] }: any) => (
    <Grid
      container
      direction="row"
      justify="flex-start"
