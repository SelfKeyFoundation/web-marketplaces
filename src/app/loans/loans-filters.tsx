...
type LoansFiltersProps =  {
  ...
  onTokenFilterChange: (any) => any; // FIXME: function type
  selectedType: string;
  onTypeFilterChange: (e: any, value: any) => any; // FIXME: function type
  onRateRangeChange: (e: any, selectedRange: any) => any; // FIXME: function type
  range: any;
  selectedRange: any;
};
...
const LoansFilters = withStyles(styles)(
  ({
    ...
    range = { min: 0, max: 100 },
    selectedRange = false
  }: LoansFiltersProps & WithStyles<typeof styles>) => (
    <Grid
      id="loans-filter"
      container
      direction="row"
